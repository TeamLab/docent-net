...
def postprocess_qa_predictions(
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        if not version_2_with_negative:
            all_predictions[example["guid"]] = {
                "predictions": predictions[0]["text"],
                "probability": str(predictions[0]["probability"]),
                "original_text": example["answers"]["text"][0], }
            ...
            if score_diff > null_score_diff_threshold:
                all_predictions[example["guid"]]["predictions"] = ""
            else:
                all_predictions[example["guid"]]["predictions"] = best_non_null_pred["text"]
    ...
    return {k: v["predictions"] for k, v in all_predictions.items()}
...
def post_processing_function(examples, features, predictions):
    ...
    predictions = postprocess_qa_predictions(
        ...
        version_2_with_negative=config.version_2_with_negative,
